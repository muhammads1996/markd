...
insert into public.labour_requirements (id, labour_request_id, skill_id, work_type, headcount) values
  ('61000000-0000-4000-8000-000000000001', '60000000-0000-4000-8000-000000000001', '30000000-0000-4000-8000-000000000001', 'General labour', 1);
insert into public.assignments (id, labour_request_id, labour_requirement_id, worker_id, organisation_id, site_id, starts_on, ends_on, lifecycle, worker_response, contractor_confirmation, agreed_rate_cents, currency) values
  ('62000000-0000-4000-8000-000000000001', '60000000-0000-4000-8000-000000000001', '61000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000001', '22000000-0000-4000-8000-000000000001', '2026-09-08', '2026-09-09', 'active', 'accepted', 'confirmed', 25000, 'ZAR');
